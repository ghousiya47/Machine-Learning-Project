import argparse
import model_functions_for_prediction

# Setup the arg parser
parser = argparse.ArgumentParser(description = 'Flower prediction')
parser.add_argument('image_file', nargs='?', default="flowers/test/10/image_07090.jpg")
...
probs, names = model_functions_for_prediction.start(args)
